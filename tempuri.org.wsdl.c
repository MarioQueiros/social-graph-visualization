...
typedef struct _tempuri_org_wsdlLocalDefinitions 
{
    ...
    struct // contracts
    {
        struct // BasicHttpBinding_IGraphs4Social_Service
        {
            ...
            struct // BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto
            {
                WS_PARAMETER_DESCRIPTION params[3];
...
typedef struct BasicHttpBinding_IGraphs4Social_Service_carregaGrafoAmigosComumParamStruct 
{
    WCHAR** username1;
    WCHAR** username2;
    Grafo** carregaGrafoAmigosComumResult;
...
typedef struct BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoParamStruct 
{
    WCHAR** username1;
    WCHAR** username2;
    WCHAR** caminhoMaisCurtoResult;
} BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoParamStruct;

#if (_MSC_VER >=1400) 
#pragma warning(push)
#endif
#pragma warning(disable: 4055) // conversion from data pointer to function pointer
HRESULT CALLBACK BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoOperationStub(
    __in const WS_OPERATION_CONTEXT* _context,
    __in void* _stackStruct,
    __in const void* _callback,
    __in_opt const WS_ASYNC_CONTEXT* _asyncContext,
    __in_opt WS_ERROR* _error)
{
    BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoCallback _operation = (BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoCallback)_callback;
    BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoParamStruct *_stack =(BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoParamStruct*)_stackStruct;
    return _operation( 
        _context,
        *(_stack->username1),
        *(_stack->username2),
        (_stack->caminhoMaisCurtoResult),
        (WS_ASYNC_CONTEXT*)_asyncContext,
        _error);
}
#pragma warning(default: 4055)  // conversion from data pointer to function pointer
...
const static _tempuri_org_wsdlLocalDefinitions tempuri_org_wsdlLocalDefinitions =
{
    { // messages
        ...
        {    // message description for IGraphs4Social_Service_caminhoMaisCurto_InputMessage
            (WS_XML_STRING*)&tempuri_org_wsdlLocalDefinitions.dictionary.xmlStrings.IGraphs4Social_Service_caminhoMaisCurto_InputMessageactionName, // http://tempuri.org/IGraphs4Social_Service/caminhoMaisCurto
            (WS_ELEMENT_DESCRIPTION*)&tempuri_org_xsd.globalElements.caminhoMaisCurto, 
        },    // message description for IGraphs4Social_Service_caminhoMaisCurto_InputMessage
    ...
    { // contracts
        {    // BasicHttpBinding_IGraphs4Social_Service,
            ...
            { // BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto
                { // parameter descriptions for BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto
                    { WS_PARAMETER_TYPE_NORMAL, (USHORT)0, (USHORT)-1 },
                    { WS_PARAMETER_TYPE_NORMAL, (USHORT)1, (USHORT)-1 },
                    { WS_PARAMETER_TYPE_NORMAL, (USHORT)-1, (USHORT)0 },
                },    // parameter descriptions for BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto
                {    // operation description for BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto
                    1,
                    (WS_MESSAGE_DESCRIPTION*)&tempuri_org_wsdl.messages.IGraphs4Social_Service_caminhoMaisCurto_InputMessage, 
                    (WS_MESSAGE_DESCRIPTION*)&tempuri_org_wsdl.messages.IGraphs4Social_Service_caminhoMaisCurto_OutputMessage, 
                    0,
                    0,
                    3,
                    (WS_PARAMETER_DESCRIPTION*)tempuri_org_wsdlLocalDefinitions.contracts.BasicHttpBinding_IGraphs4Social_Service.BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto.params,
                    BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurtoOperationStub,
                    WS_NON_RPC_LITERAL_OPERATION
                }, //operation description for BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto
            },  // BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto
    ...
    __in_opt WS_ERROR* _error)
{
    ...
    _argList[0] = &username1;
    _argList[1] = &username2;
    _argList[2] = &caminhoMaisCurtoResult;
    return WsCall(_serviceProxy,
        (WS_OPERATION_DESCRIPTION*)&tempuri_org_wsdlLocalDefinitions.contracts.BasicHttpBinding_IGraphs4Social_Service.BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto.BasicHttpBinding_IGraphs4Social_Service_caminhoMaisCurto,
        (const void **)&_argList,
        _heap,

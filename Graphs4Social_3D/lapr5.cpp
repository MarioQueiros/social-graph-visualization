...
void initEstado()
{
	...
	estado.eixo[1]=0;
	estado.eixo[2]=0;
	estado.camera.eye.x = 5.0 * nos[0].x; 
	estado.camera.eye.y = 5.0 * nos[0].y;
...
void Square (int x, int y, GLuint texID)
{
	//material(azul);
...
void display(void)
{
	...
	Square(estado.posMouse.posMouseX,glutGet(GLUT_WINDOW_HEIGHT)-estado.posMouse.posMouseY,modelo.texID[ID_TEXTURA_CHAO]);
